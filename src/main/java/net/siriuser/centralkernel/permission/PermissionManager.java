...
import net.siriuser.centralkernel.permission.plugin.PermissionsEx;
import net.siriuser.centralkernel.permission.plugin.SuperPermission;
...
public class PermissionManager {
    ...
    public static void setupPermissions(final CentralKernelCore plugin){
        final String selected = PluginHelper.getInstance().getConfig().getPermissionCtrl();
        boolean found = true;
